...
public class NoticeFileTest {
	...
	public void noticeFileTest() throws Exception {
		String markdown = generateSilentsoftCoreNoticeMarkdown();
	...
	private String generateSilentsoftCoreNoticeMarkdown() {
		return NoticeFileGenerator.newInstance("silentsoft-core", "silentsoft.org")
